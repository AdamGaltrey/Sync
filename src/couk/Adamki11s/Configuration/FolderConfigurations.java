...
public class FolderConfigurations {
	...
	private static final File root = new File("plugins" + File.separator + "Sync"), pluginStatistics = new File(root + File.separator + "Plugin Statistics"),
			syncConfiguration = new File(root + File.separator + "Sync Configuration"), syncBackups = new File(root + File.separator + "Backups");
